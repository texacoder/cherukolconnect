...
const I18N = {
  en: {
    ...
    "gramasabha.eyebrow": "Grassroots Democracy",
    "gramasabha.title": "What is a Grama Sabha?",
    "gramasabha.body": "The Grama Sabha is the general assembly of every registered voter in a ward — the foundation of local self-government in Kerala. It meets to discuss local needs, help shape the Panchayath's development plans, select beneficiaries for welfare schemes, and review the Panchayath's work through social audit.",
    "gramasabha.freq": "Meetings a year",
    "gramasabha.notice": "Advance notice required",
    "gramasabha.quorum": "Quorum of ward voters",
    "gramasabha.source": "Source: The Kerala Panchayat Raj Act, 1994.",

    "functions.eyebrow": "Local Governance",
    "functions.title": "What the Panchayath Does",
    "functions.sub": "Grama Panchayaths in Kerala are responsible for a wide range of local services and development work, devolved under the 73rd Constitutional Amendment and the Kerala Panchayat Raj Act.",
    "functions.civic.title": "Civic Infrastructure",
    "functions.civic.desc": "Roads, drains, street lighting, and drinking water supply.",
    "functions.health.title": "Public Health & Sanitation",
    "functions.health.desc": "Waste management, sanitation, and local health facilities.",
    "functions.agri.title": "Agriculture & Allied",
    "functions.agri.desc": "Agriculture, land improvement, minor irrigation, and animal husbandry.",
    "functions.welfare.title": "Social Welfare",
    "functions.welfare.desc": "Support for weaker sections, women, children, and poverty alleviation.",
    "functions.edu.title": "Education & Culture",
    "functions.edu.desc": "Support for schools, libraries, and cultural programmes.",
    "functions.planning.title": "Local Development Planning",
    "functions.planning.desc": "Preparing and executing the Panchayath's own development plan.",
    "functions.source": "Source: The Eleventh Schedule of the Constitution of India, and the Kerala Panchayat Raj Act, 1994.",

    "schemes.eyebrow": "Government Schemes",
    "schemes.title": "Schemes You May Be Eligible For",
    "schemes.sub": "A few major Central and Kerala government welfare schemes. Eligibility and application details change from time to time — check the official site linked, or ask at the Panchayath office, before applying.",
    "schemes.kisan.desc": "₹6,000/year income support for eligible farmer families, paid in three instalments.",
    "schemes.mgnrega.desc": "Guaranteed 100 days of wage employment a year for rural households.",
    "schemes.kasp.title": "Karunya Arogya Suraksha Padhathi (KASP)",
    "schemes.kasp.desc": "Cashless health insurance up to ₹5 lakh per family per year for eligible families.",
    "schemes.kudumbashree.title": "Kudumbashree",
    "schemes.kudumbashree.desc": "Kerala's poverty eradication and women's empowerment programme, built on local self-help groups.",
    "schemes.life.title": "LIFE Mission",
    "schemes.life.desc": "Free housing for landless and homeless families in Kerala.",
    "schemes.pension.title": "Social Security Pensions",
    "schemes.pension.desc": "Monthly pensions for elderly, widowed, and differently-abled residents.",
    "schemes.source": "These are national/state programmes, not specific to Cherukole Panchayath — visit the official site or the Panchayath office to check current eligibility.",
  ...
  ml: {
    ...
    "gramasabha.eyebrow": "അടിസ്ഥാന ജനാധിപത്യം",
    "gramasabha.title": "എന്താണ് ഗ്രാമസഭ?",
    "gramasabha.body": "ഒരു വാർഡിലെ എല്ലാ രജിസ്റ്റർ ചെയ്ത വോട്ടർമാരും ഉൾപ്പെടുന്ന പൊതുസഭയാണ് ഗ്രാമസഭ — കേരളത്തിലെ തദ്ദേശ സ്വയംഭരണത്തിന്റെ അടിത്തറ. പ്രാദേശിക ആവശ്യങ്ങൾ ചർച്ച ചെയ്യാനും പഞ്ചായത്തിന്റെ വികസന പദ്ധതികൾ രൂപപ്പെടുത്താനും ക്ഷേമപദ്ധതികളുടെ ഗുണഭോക്താക്കളെ തിരഞ്ഞെടുക്കാനും സാമൂഹിക ഓഡിറ്റിലൂടെ പഞ്ചായത്തിന്റെ പ്രവർത്തനങ്ങൾ വിലയിരുത്താനും ഇത് യോഗം ചേരുന്നു.",
    "gramasabha.freq": "വർഷം തോറുമുള്ള യോഗങ്ങൾ",
    "gramasabha.notice": "മുൻകൂർ അറിയിപ്പ് വേണം",
    "gramasabha.quorum": "കോറം (വാർഡ് വോട്ടർമാരുടെ)",
    "gramasabha.source": "സ്രോതസ്സ്: കേരള പഞ്ചായത്ത് രാജ് ആക്റ്റ്, 1994.",

    "functions.eyebrow": "തദ്ദേശ ഭരണം",
    "functions.title": "പഞ്ചായത്തിന്റെ പ്രവർത്തന മേഖലകൾ",
    "functions.sub": "ഭരണഘടനയുടെ 73-ാം ഭേദഗതിയും കേരള പഞ്ചായത്ത് രാജ് ആക്റ്റും അനുസരിച്ച് കൈമാറ്റം ചെയ്യപ്പെട്ട, വിശാലമായ പ്രാദേശിക സേവനങ്ങളുടെയും വികസന പ്രവർത്തനങ്ങളുടെയും ചുമതല കേരളത്തിലെ ഗ്രാമപഞ്ചായത്തുകൾക്കാണ്.",
    "functions.civic.title": "പൊതു അടിസ്ഥാന സൗകര്യങ്ങൾ",
    "functions.civic.desc": "റോഡുകൾ, ഓടകൾ, തെരുവ് വിളക്കുകൾ, കുടിവെള്ള വിതരണം.",
    "functions.health.title": "പൊതുജനാരോഗ്യവും ശുചിത്വവും",
    "functions.health.desc": "മാലിന്യ സംസ്കരണം, ശുചിത്വം, പ്രാദേശിക ആരോഗ്യ കേന്ദ്രങ്ങൾ.",
    "functions.agri.title": "കൃഷിയും അനുബന്ധ മേഖലകളും",
    "functions.agri.desc": "കൃഷി, ഭൂമി വികസനം, ചെറുകിട ജലസേചനം, മൃഗസംരക്ഷണം.",
    "functions.welfare.title": "സാമൂഹിക ക്ഷേമം",
    "functions.welfare.desc": "പിന്നാക്ക വിഭാഗങ്ങൾക്കും സ്ത്രീകൾക്കും കുട്ടികൾക്കുമുള്ള പിന്തുണ, ദാരിദ്ര്യ നിർമ്മാർജ്ജനം.",
    "functions.edu.title": "വിദ്യാഭ്യാസവും സംസ്കാരവും",
    "functions.edu.desc": "സ്കൂളുകൾ, ലൈബ്രറികൾ, സാംസ്കാരിക പരിപാടികൾ എന്നിവയ്ക്കുള്ള പിന്തുണ.",
    "functions.planning.title": "പ്രാദേശിക വികസന ആസൂത്രണം",
    "functions.planning.desc": "പഞ്ചായത്തിന്റെ സ്വന്തം വികസന പദ്ധതി തയ്യാറാക്കലും നടപ്പാക്കലും.",
    "functions.source": "സ്രോതസ്സ്: ഇന്ത്യൻ ഭരണഘടനയുടെ പതിനൊന്നാം പട്ടിക, കേരള പഞ്ചായത്ത് രാജ് ആക്റ്റ്, 1994.",

    "schemes.eyebrow": "സർക്കാർ പദ്ധതികൾ",
    "schemes.title": "നിങ്ങൾക്ക് അർഹതയുണ്ടാകാവുന്ന പദ്ധതികൾ",
    "schemes.sub": "കേന്ദ്ര, കേരള സർക്കാരുകളുടെ ചില പ്രധാന ക്ഷേമ പദ്ധതികൾ. യോഗ്യതയും അപേക്ഷാ വിവരങ്ങളും കാലാകാലങ്ങളിൽ മാറാം — അപേക്ഷിക്കുന്നതിന് മുൻപ് ഔദ്യോഗിക വെബ്സൈറ്റ് പരിശോധിക്കുകയോ പഞ്ചായത്ത് ഓഫീസിൽ അന്വേഷിക്കുകയോ ചെയ്യുക.",
    "schemes.kisan.desc": "യോഗ്യരായ കർഷക കുടുംബങ്ങൾക്ക് വർഷം ₹6,000 വരുമാന സഹായം, മൂന്ന് ഗഡുക്കളായി.",
    "schemes.mgnrega.desc": "ഗ്രാമീണ കുടുംബങ്ങൾക്ക് വർഷം 100 ദിവസത്തെ വേതന തൊഴിൽ ഉറപ്പ്.",
    "schemes.kasp.title": "കാരുണ്യ ആരോഗ്യ സുരക്ഷാ പദ്ധതി (KASP)",
    "schemes.kasp.desc": "യോഗ്യരായ കുടുംബങ്ങൾക്ക് വർഷം ₹5 ലക്ഷം വരെ ക്യാഷ്‌ലെസ് ആരോഗ്യ ഇൻഷുറൻസ്.",
    "schemes.kudumbashree.title": "കുടുംബശ്രീ",
    "schemes.kudumbashree.desc": "അയൽക്കൂട്ടങ്ങളെ അടിസ്ഥാനമാക്കിയുള്ള കേരളത്തിന്റെ ദാരിദ്ര്യ നിർമ്മാർജ്ജന, സ്ത്രീ ശാക്തീകരണ പദ്ധതി.",
    "schemes.life.title": "ലൈഫ് മിഷൻ",
    "schemes.life.desc": "ഭൂരഹിതരും ഭവനരഹിതരുമായ കുടുംബങ്ങൾക്ക് കേരളത്തിൽ സൗജന്യ വീട്.",
    "schemes.pension.title": "സാമൂഹിക സുരക്ഷാ പെൻഷനുകൾ",
    "schemes.pension.desc": "പ്രായമായവർക്കും വിധവകൾക്കും ഭിന്നശേഷിക്കാർക്കും പ്രതിമാസ പെൻഷൻ.",
    "schemes.source": "ഇവ ദേശീയ/സംസ്ഥാന പദ്ധതികളാണ്, ചെറുകോൽ പഞ്ചായത്തിന് മാത്രമായുള്ളതല്ല — നിലവിലെ യോഗ്യത അറിയാൻ ഔദ്യോഗിക വെബ്സൈറ്റോ പഞ്ചായത്ത് ഓഫീസോ സന്ദർശിക്കുക.",
